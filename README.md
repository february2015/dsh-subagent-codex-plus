...
```sh
dsh plugin --profile <name> add /path/to/dsh-subagent-codex-plus-plus
dsh plugin --profile <name> remove dsh-subagent-codex-plus-plus
dsh --profile <name>
```
...
- [Generated configuration catalog](../../../docs/config-catalog.md#deepseek-aidsh-subagent-codex-plus) — every accepted config field and its source declaration.
